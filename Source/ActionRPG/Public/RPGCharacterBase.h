...
protected:
	...
	void StartDecreaseStamina(float StaminaCost, float decreaseTime);

	UFUNCTION(BlueprintCallable, Category = "Character")
	void StopDecreaseStamina(float RegenCost, float regenTime);
	/**
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent)
	void OnStaminaChanged(float DeltaValue);
	...
	virtual void HandleStaminaChanged(float DeltaValue);
